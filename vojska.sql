...
INSERT INTO popravak VALUES
 ( 6001 , 2019 , "Vozilu je potrebna kompletna restauracija" , STR_TO_DATE("2.11.1992.", "%d.%m.%Y.") , STR_TO_DATE("9.3.2024.", "%d.%m.%Y.") , 235475 ),
 ( 6002 , 2018 , "Potrebni mali popravci" , STR_TO_DATE("14.11.2030.", "%d.%m.%Y.") , STR_TO_DATE("25.3.2026.", "%d.%m.%Y.") , 429969 ),
 ( 6003 , 2005 , "Popravci na rubu neisplativosti" , STR_TO_DATE("9.3.1993.", "%d.%m.%Y.") , STR_TO_DATE("12.12.2023.", "%d.%m.%Y.") , 374594 ),
 ( 6004 , 2006 , "Popravci na rubu neisplativosti" , STR_TO_DATE("10.2.2027.", "%d.%m.%Y.") , STR_TO_DATE("24.3.2025.", "%d.%m.%Y.") , 303429 ),
 ( 6005 , 2009 , "Vozilu je potrebna kompletna restauracija" , STR_TO_DATE("14.10.2015.", "%d.%m.%Y.") , STR_TO_DATE("19.1.2008.", "%d.%m.%Y.") , 299849 ),
 ( 6006 , 2003 , "Popravci na rubu neisplativosti" , STR_TO_DATE("22.7.2028.", "%d.%m.%Y.") , STR_TO_DATE("17.12.2018.", "%d.%m.%Y.") , 472183 ),
 ( 6007 , 2017 , "Manja šteta na oklopu i manji popravci" , STR_TO_DATE("25.12.2017.", "%d.%m.%Y.") , STR_TO_DATE("23.9.2007.", "%d.%m.%Y.") , 345516 ),
 ( 6008 , 2003 , "Popravci na rubu neisplativosti" , STR_TO_DATE("18.3.2030.", "%d.%m.%Y.") , STR_TO_DATE("3.7.2005.", "%d.%m.%Y.") , 339466 ),
 ( 6009 , 2016 , "Vozilo nije u voznome stanju" , STR_TO_DATE("5.3.2022.", "%d.%m.%Y.") , STR_TO_DATE("11.8.2006.", "%d.%m.%Y.") , 202165 ),
 ( 6010 , 2012 , "Vozilo nije u voznome stanju" , STR_TO_DATE("18.8.1996.", "%d.%m.%Y.") , STR_TO_DATE("2.12.2019.", "%d.%m.%Y.") , 247772 ),
 ( 6011 , 2019 , "Popravci na rubu neisplativosti" , STR_TO_DATE("23.6.2024.", "%d.%m.%Y.") , STR_TO_DATE("18.7.2005.", "%d.%m.%Y.") , 253430 ),
 ( 6012 , 2003 , "Vozilu je potrebna kompletna restauracija" , STR_TO_DATE("14.9.2024.", "%d.%m.%Y.") , STR_TO_DATE("7.9.2029.", "%d.%m.%Y.") , 267460 ),
 ( 6013 , 2005 , "Popravci na rubu neisplativosti" , STR_TO_DATE("13.2.1997.", "%d.%m.%Y.") , STR_TO_DATE("17.6.1999.", "%d.%m.%Y.") , 367066 ),
 ( 6014 , 2006 , "Manja šteta na oklopu i manji popravci" , STR_TO_DATE("20.10.2028.", "%d.%m.%Y.") , STR_TO_DATE("6.9.2004.", "%d.%m.%Y.") , 356967 ),
 ( 6015 , 2007 , "Popravci na rubu neisplativosti" , STR_TO_DATE("13.8.2004.", "%d.%m.%Y.") , STR_TO_DATE("8.2.2001.", "%d.%m.%Y.") , 482278 ),
 ( 6016 , 2020 , "Potrebni mali popravci" , STR_TO_DATE("1.9.2008.", "%d.%m.%Y.") , STR_TO_DATE("28.5.2011.", "%d.%m.%Y.") , 324646 ),
 ( 6017 , 2018 , "Vozilo nije u voznome stanju" , STR_TO_DATE("28.10.2030.", "%d.%m.%Y.") , STR_TO_DATE("21.2.2027.", "%d.%m.%Y.") , 220281 ),
 ( 6018 , 2006 , "Manja šteta na oklopu i manji popravci" , STR_TO_DATE("9.1.2003.", "%d.%m.%Y.") , STR_TO_DATE("12.12.1994.", "%d.%m.%Y.") , 213060 ),
 ( 6019 , 2004 , "Potrebni mali popravci" , STR_TO_DATE("14.3.2022.", "%d.%m.%Y.") , STR_TO_DATE("1.2.2007.", "%d.%m.%Y.") , 277448 ),
 ( 6020 , 2016 , "Popravci na rubu neisplativosti" , STR_TO_DATE("3.2.2029.", "%d.%m.%Y.") , STR_TO_DATE("5.12.2020.", "%d.%m.%Y.") , 441037 );
...
INSERT INTO trening VALUES
 ( 1100 , STR_TO_DATE("20.7.1991.  4:9:55", "%d.%m.%Y.") , STR_TO_DATE("14.7.1991.  2:14:36", "%d.%m.%Y.") , 35 , ),
 ( 1101 , STR_TO_DATE("27.2.1995.  6:15:60", "%d.%m.%Y.") , STR_TO_DATE("5.8.1999.  24:16:47", "%d.%m.%Y.") , 18 , ),
 ( 1102 , STR_TO_DATE("22.5.1997.  4:31:41", "%d.%m.%Y.") , STR_TO_DATE("5.11.2000.  3:48:37", "%d.%m.%Y.") , 27 , ),
 ( 1103 , STR_TO_DATE("9.6.1994.  24:25:56", "%d.%m.%Y.") , STR_TO_DATE("22.4.1993.  23:23:29", "%d.%m.%Y.") , 24 , ),
 ( 1104 , STR_TO_DATE("19.11.1993.  4:43:36", "%d.%m.%Y.") , STR_TO_DATE("25.10.1999.  17:37:18", "%d.%m.%Y.") , 39 , ),
 ( 1105 , STR_TO_DATE("5.8.1998.  19:35:30", "%d.%m.%Y.") , STR_TO_DATE("13.8.1991.  11:25:21", "%d.%m.%Y.") , 25 , ),
 ( 1106 , STR_TO_DATE("19.1.1996.  12:5:20", "%d.%m.%Y.") , STR_TO_DATE("22.10.1998.  20:43:49", "%d.%m.%Y.") , 21 , ),
 ( 1107 , STR_TO_DATE("2.5.1994.  11:18:29", "%d.%m.%Y.") , STR_TO_DATE("19.1.1992.  22:24:60", "%d.%m.%Y.") , 38 , ),
 ( 1108 , STR_TO_DATE("1.1.1996.  24:42:3", "%d.%m.%Y.") , STR_TO_DATE("28.8.1992.  10:30:35", "%d.%m.%Y.") , 34 , ),
 ( 1109 , STR_TO_DATE("21.6.1993.  23:55:36", "%d.%m.%Y.") , STR_TO_DATE("1.6.1991.  14:56:42", "%d.%m.%Y.") , 30 , ),
 ( 1110 , STR_TO_DATE("20.1.1992.  1:37:10", "%d.%m.%Y.") , STR_TO_DATE("7.1.2000.  18:45:6", "%d.%m.%Y.") , 40 , ),
 ( 1111 , STR_TO_DATE("12.8.1995.  19:48:17", "%d.%m.%Y.") , STR_TO_DATE("21.9.1991.  15:4:3", "%d.%m.%Y.") , 29 , ),
 ( 1112 , STR_TO_DATE("16.10.1991.  16:57:7", "%d.%m.%Y.") , STR_TO_DATE("3.5.1998.  21:3:38", "%d.%m.%Y.") , 17 , ),
 ( 1113 , STR_TO_DATE("20.5.1995.  20:28:58", "%d.%m.%Y.") , STR_TO_DATE("5.12.1996.  12:50:1", "%d.%m.%Y.") , 37 , ),
 ( 1114 , STR_TO_DATE("21.11.1997.  16:23:43", "%d.%m.%Y.") , STR_TO_DATE("12.4.1992.  22:10:22", "%d.%m.%Y.") , 29 , ),
 ( 1115 , STR_TO_DATE("12.11.1996.  6:21:9", "%d.%m.%Y.") , STR_TO_DATE("2.5.1999.  14:44:2", "%d.%m.%Y.") , 43 , ),
 ( 1116 , STR_TO_DATE("20.3.1994.  8:8:50", "%d.%m.%Y.") , STR_TO_DATE("14.7.1995.  8:5:55", "%d.%m.%Y.") , 43 , ),
 ( 1117 , STR_TO_DATE("18.1.1998.  19:16:34", "%d.%m.%Y.") , STR_TO_DATE("1.10.1996.  12:37:13", "%d.%m.%Y.") , 41 , ),
 ( 1118 , STR_TO_DATE("24.10.1996.  5:17:41", "%d.%m.%Y.") , STR_TO_DATE("28.2.2000.  9:25:56", "%d.%m.%Y.") , 22 , ),
 ( 1119 , STR_TO_DATE("15.5.1993.  22:56:17", "%d.%m.%Y.") , STR_TO_DATE("24.1.2000.  6:1:44", "%d.%m.%Y.") , 45 , ),
 ( 1120 , STR_TO_DATE("27.10.1992.  21:7:48", "%d.%m.%Y.") , STR_TO_DATE("16.8.1992.  5:30:37", "%d.%m.%Y.") , 23 , ),
 ( 1121 , STR_TO_DATE("20.5.1994.  9:8:49", "%d.%m.%Y.") , STR_TO_DATE("2.11.2000.  13:35:57", "%d.%m.%Y.") , 22 , ),
 ( 1122 , STR_TO_DATE("5.7.1995.  22:40:32", "%d.%m.%Y.") , STR_TO_DATE("6.12.1991.  11:2:9", "%d.%m.%Y.") , 45 , ),
 ( 1123 , STR_TO_DATE("20.4.1996.  3:52:12", "%d.%m.%Y.") , STR_TO_DATE("5.8.1993.  6:14:51", "%d.%m.%Y.") , 39 , ),
 ( 1124 , STR_TO_DATE("1.2.1998.  9:25:31", "%d.%m.%Y.") , STR_TO_DATE("17.11.1994.  9:30:11", "%d.%m.%Y.") , 24 , ),
 ( 1125 , STR_TO_DATE("28.8.1998.  9:16:47", "%d.%m.%Y.") , STR_TO_DATE("21.6.1991.  14:33:47", "%d.%m.%Y.") , 35 , ),
 ( 1126 , STR_TO_DATE("7.1.1994.  15:20:27", "%d.%m.%Y.") , STR_TO_DATE("13.10.1996.  13:23:6", "%d.%m.%Y.") , 43 , ),
 ( 1127 , STR_TO_DATE("16.6.1998.  3:33:10", "%d.%m.%Y.") , STR_TO_DATE("28.5.2000.  12:4:16", "%d.%m.%Y.") , 28 , ),
 ( 1128 , STR_TO_DATE("4.4.2000.  13:2:15", "%d.%m.%Y.") , STR_TO_DATE("2.5.1992.  1:51:5", "%d.%m.%Y.") , 39 , ),
 ( 1129 , STR_TO_DATE("24.12.1994.  11:9:8", "%d.%m.%Y.") , STR_TO_DATE("6.5.2000.  23:43:55", "%d.%m.%Y.") , 20 , ),
 ( 1130 , STR_TO_DATE("16.10.2000.  3:56:34", "%d.%m.%Y.") , STR_TO_DATE("27.5.2000.  6:21:30", "%d.%m.%Y.") , 26 , ),
 ( 1131 , STR_TO_DATE("19.7.1998.  24:52:10", "%d.%m.%Y.") , STR_TO_DATE("9.1.2000.  7:20:0", "%d.%m.%Y.") , 31 , ),
 ( 1132 , STR_TO_DATE("25.4.1996.  24:10:57", "%d.%m.%Y.") , STR_TO_DATE("8.3.2000.  8:54:27", "%d.%m.%Y.") , 40 , ),
 ( 1133 , STR_TO_DATE("28.10.1994.  21:39:14", "%d.%m.%Y.") , STR_TO_DATE("20.4.1994.  18:12:41", "%d.%m.%Y.") , 40 , ),
 ( 1134 , STR_TO_DATE("4.3.1991.  11:25:60", "%d.%m.%Y.") , STR_TO_DATE("16.3.1998.  5:35:19", "%d.%m.%Y.") , 34 , ),
 ( 1135 , STR_TO_DATE("13.5.1998.  23:25:6", "%d.%m.%Y.") , STR_TO_DATE("20.8.1991.  4:19:41", "%d.%m.%Y.") , 30 , ),
 ( 1136 , STR_TO_DATE("15.3.1991.  21:30:22", "%d.%m.%Y.") , STR_TO_DATE("19.1.1991.  5:48:10", "%d.%m.%Y.") , 36 , ),
 ( 1137 , STR_TO_DATE("22.5.1993.  11:55:28", "%d.%m.%Y.") , STR_TO_DATE("12.2.1995.  16:58:45", "%d.%m.%Y.") , 27 , ),
 ( 1138 , STR_TO_DATE("26.2.1997.  7:17:39", "%d.%m.%Y.") , STR_TO_DATE("12.5.1996.  23:40:8", "%d.%m.%Y.") , 40 , ),
 ( 1139 , STR_TO_DATE("26.2.1997.  14:36:47", "%d.%m.%Y.") , STR_TO_DATE("22.9.1996.  10:5:50", "%d.%m.%Y.") , 46 , ),
 ( 1140 , STR_TO_DATE("24.5.1995.  22:24:54", "%d.%m.%Y.") , STR_TO_DATE("9.8.1993.  15:6:12", "%d.%m.%Y.") , 40 , ),
 ( 1141 , STR_TO_DATE("5.5.1996.  6:14:47", "%d.%m.%Y.") , STR_TO_DATE("3.3.2000.  6:36:38", "%d.%m.%Y.") , 17 , ),
 ( 1142 , STR_TO_DATE("4.12.1993.  14:23:23", "%d.%m.%Y.") , STR_TO_DATE("24.11.1996.  9:30:29", "%d.%m.%Y.") , 42 , ),
 ( 1143 , STR_TO_DATE("25.9.1994.  3:50:8", "%d.%m.%Y.") , STR_TO_DATE("11.7.1992.  16:38:58", "%d.%m.%Y.") , 17 , ),
 ( 1144 , STR_TO_DATE("14.10.2000.  3:28:3", "%d.%m.%Y.") , STR_TO_DATE("6.8.1998.  14:46:54", "%d.%m.%Y.") , 42 , ),
 ( 1145 , STR_TO_DATE("7.11.1999.  22:26:4", "%d.%m.%Y.") , STR_TO_DATE("20.3.2000.  19:58:33", "%d.%m.%Y.") , 18 , ),
 ( 1146 , STR_TO_DATE("19.2.1998.  1:37:15", "%d.%m.%Y.") , STR_TO_DATE("23.7.1998.  7:32:23", "%d.%m.%Y.") , 24 , ),
 ( 1147 , STR_TO_DATE("12.6.1991.  11:19:55", "%d.%m.%Y.") , STR_TO_DATE("28.2.1999.  14:48:19", "%d.%m.%Y.") , 33 , ),
 ( 1148 , STR_TO_DATE("12.9.1994.  5:28:31", "%d.%m.%Y.") , STR_TO_DATE("13.10.1994.  12:26:38", "%d.%m.%Y.") , 19 , ),
 ( 1149 , STR_TO_DATE("6.9.1991.  6:14:44", "%d.%m.%Y.") , STR_TO_DATE("27.12.1999.  5:17:57", "%d.%m.%Y.") , 34 , ),
 ( 1150 , STR_TO_DATE("16.6.1991.  12:57:7", "%d.%m.%Y.") , STR_TO_DATE("16.4.1999.  15:60:44", "%d.%m.%Y.") , 17 , ),
 ( 1151 , STR_TO_DATE("12.11.1992.  16:36:7", "%d.%m.%Y.") , STR_TO_DATE("10.5.1997.  22:52:18", "%d.%m.%Y.") , 46 , ),
 ( 1152 , STR_TO_DATE("18.12.1997.  16:30:51", "%d.%m.%Y.") , STR_TO_DATE("8.1.1993.  19:0:52", "%d.%m.%Y.") , 45 , ),
 ( 1153 , STR_TO_DATE("23.2.1995.  11:23:13", "%d.%m.%Y.") , STR_TO_DATE("19.11.1993.  3:35:37", "%d.%m.%Y.") , 27 , ),
 ( 1154 , STR_TO_DATE("13.5.1999.  6:56:6", "%d.%m.%Y.") , STR_TO_DATE("20.10.1997.  22:40:16", "%d.%m.%Y.") , 28 , ),
 ( 1155 , STR_TO_DATE("16.9.1997.  19:46:42", "%d.%m.%Y.") , STR_TO_DATE("15.1.1997.  7:32:50", "%d.%m.%Y.") , 45 , ),
 ( 1156 , STR_TO_DATE("7.4.1996.  20:9:5", "%d.%m.%Y.") , STR_TO_DATE("20.12.1994.  11:6:50", "%d.%m.%Y.") , 23 , ),
 ( 1157 , STR_TO_DATE("8.10.1998.  22:51:15", "%d.%m.%Y.") , STR_TO_DATE("24.3.1993.  1:40:43", "%d.%m.%Y.") , 27 , ),
 ( 1158 , STR_TO_DATE("10.1.1991.  24:33:32", "%d.%m.%Y.") , STR_TO_DATE("2.6.1995.  8:18:50", "%d.%m.%Y.") , 34 , ),
 ( 1159 , STR_TO_DATE("11.3.1993.  4:28:8", "%d.%m.%Y.") , STR_TO_DATE("17.1.1991.  3:33:45", "%d.%m.%Y.") , 24 , ),
 ( 1160 , STR_TO_DATE("17.3.1996.  2:27:22", "%d.%m.%Y.") , STR_TO_DATE("12.9.1995.  11:21:31", "%d.%m.%Y.") , 34 , ),
 ( 1161 , STR_TO_DATE("26.2.1995.  16:20:34", "%d.%m.%Y.") , STR_TO_DATE("8.9.1991.  22:15:42", "%d.%m.%Y.") , 29 , ),
 ( 1162 , STR_TO_DATE("1.7.1998.  8:39:0", "%d.%m.%Y.") , STR_TO_DATE("6.6.1992.  1:53:50", "%d.%m.%Y.") , 18 , ),
 ( 1163 , STR_TO_DATE("23.8.1992.  16:30:29", "%d.%m.%Y.") , STR_TO_DATE("1.2.1996.  6:37:15", "%d.%m.%Y.") , 30 , ),
 ( 1164 , STR_TO_DATE("12.6.1992.  7:10:53", "%d.%m.%Y.") , STR_TO_DATE("11.11.1993.  12:25:26", "%d.%m.%Y.") , 32 , ),
 ( 1165 , STR_TO_DATE("6.4.1993.  8:22:41", "%d.%m.%Y.") , STR_TO_DATE("19.9.1996.  4:25:15", "%d.%m.%Y.") , 27 , ),
 ( 1166 , STR_TO_DATE("18.12.1996.  17:60:58", "%d.%m.%Y.") , STR_TO_DATE("2.1.1994.  24:6:41", "%d.%m.%Y.") , 34 , ),
 ( 1167 , STR_TO_DATE("21.11.1994.  21:21:53", "%d.%m.%Y.") , STR_TO_DATE("27.6.1992.  2:55:20", "%d.%m.%Y.") , 24 , ),
 ( 1168 , STR_TO_DATE("11.8.1999.  19:22:16", "%d.%m.%Y.") , STR_TO_DATE("17.8.1995.  19:12:44", "%d.%m.%Y.") , 30 , ),
 ( 1169 , STR_TO_DATE("17.10.2000.  5:5:4", "%d.%m.%Y.") , STR_TO_DATE("18.4.1995.  6:15:2", "%d.%m.%Y.") , 23 , ),
 ( 1170 , STR_TO_DATE("11.10.1997.  9:20:43", "%d.%m.%Y.") , STR_TO_DATE("27.1.1992.  2:18:19", "%d.%m.%Y.") , 17 , ),
 ( 1171 , STR_TO_DATE("19.9.1991.  18:7:9", "%d.%m.%Y.") , STR_TO_DATE("27.12.1996.  12:47:10", "%d.%m.%Y.") , 31 , ),
 ( 1172 , STR_TO_DATE("24.6.1994.  13:16:23", "%d.%m.%Y.") , STR_TO_DATE("23.10.1994.  4:31:11", "%d.%m.%Y.") , 21 , ),
 ( 1173 , STR_TO_DATE("8.7.1995.  20:2:22", "%d.%m.%Y.") , STR_TO_DATE("14.2.1998.  11:58:54", "%d.%m.%Y.") , 17 , ),
 ( 1174 , STR_TO_DATE("21.1.1992.  4:33:2", "%d.%m.%Y.") , STR_TO_DATE("25.1.2000.  1:50:14", "%d.%m.%Y.") , 34 , ),
 ( 1175 , STR_TO_DATE("17.4.1999.  15:36:55", "%d.%m.%Y.") , STR_TO_DATE("26.4.1992.  14:48:20", "%d.%m.%Y.") , 17 , ),
 ( 1176 , STR_TO_DATE("11.8.1997.  6:55:33", "%d.%m.%Y.") , STR_TO_DATE("22.8.1993.  5:17:41", "%d.%m.%Y.") , 23 , ),
 ( 1177 , STR_TO_DATE("20.12.1997.  8:8:9", "%d.%m.%Y.") , STR_TO_DATE("1.11.1993.  9:14:9", "%d.%m.%Y.") , 33 , ),
 ( 1178 , STR_TO_DATE("4.2.1992.  12:48:4", "%d.%m.%Y.") , STR_TO_DATE("26.12.1999.  6:53:23", "%d.%m.%Y.") , 28 , ),
 ( 1179 , STR_TO_DATE("18.8.1998.  20:3:1", "%d.%m.%Y.") , STR_TO_DATE("26.11.1991.  16:37:9", "%d.%m.%Y.") , 39 , ),
 ( 1180 , STR_TO_DATE("21.12.1998.  11:21:2", "%d.%m.%Y.") , STR_TO_DATE("10.9.1991.  17:46:43", "%d.%m.%Y.") , 24 , ),
 ( 1181 , STR_TO_DATE("21.8.1993.  12:2:34", "%d.%m.%Y.") , STR_TO_DATE("19.5.2000.  13:28:31", "%d.%m.%Y.") , 40 , ),
 ( 1182 , STR_TO_DATE("8.7.1994.  4:1:4", "%d.%m.%Y.") , STR_TO_DATE("18.3.1994.  18:60:39", "%d.%m.%Y.") , 35 , ),
 ( 1183 , STR_TO_DATE("21.11.1998.  23:42:5", "%d.%m.%Y.") , STR_TO_DATE("26.11.1993.  14:19:40", "%d.%m.%Y.") , 23 , ),
 ( 1184 , STR_TO_DATE("7.2.1995.  13:7:52", "%d.%m.%Y.") , STR_TO_DATE("22.10.1998.  24:52:4", "%d.%m.%Y.") , 31 , ),
 ( 1185 , STR_TO_DATE("10.12.1995.  17:10:58", "%d.%m.%Y.") , STR_TO_DATE("16.12.1995.  17:25:29", "%d.%m.%Y.") , 23 , ),
 ( 1186 , STR_TO_DATE("1.2.2000.  13:15:16", "%d.%m.%Y.") , STR_TO_DATE("16.10.1992.  18:46:37", "%d.%m.%Y.") , 32 , ),
 ( 1187 , STR_TO_DATE("21.8.1991.  16:23:30", "%d.%m.%Y.") , STR_TO_DATE("1.3.1995.  22:56:27", "%d.%m.%Y.") , 17 , ),
 ( 1188 , STR_TO_DATE("11.9.1991.  6:52:17", "%d.%m.%Y.") , STR_TO_DATE("15.9.1994.  18:9:25", "%d.%m.%Y.") , 42 , ),
 ( 1189 , STR_TO_DATE("15.2.1993.  3:39:53", "%d.%m.%Y.") , STR_TO_DATE("1.9.1999.  15:25:59", "%d.%m.%Y.") , 20 , ),
 ( 1190 , STR_TO_DATE("5.6.1998.  11:14:52", "%d.%m.%Y.") , STR_TO_DATE("1.6.2000.  16:14:1", "%d.%m.%Y.") , 31 , ),
 ( 1191 , STR_TO_DATE("5.5.1997.  24:32:1", "%d.%m.%Y.") , STR_TO_DATE("20.1.1993.  4:49:19", "%d.%m.%Y.") , 33 , ),
 ( 1192 , STR_TO_DATE("8.7.1999.  7:42:45", "%d.%m.%Y.") , STR_TO_DATE("18.4.1998.  18:13:31", "%d.%m.%Y.") , 29 , ),
 ( 1193 , STR_TO_DATE("21.10.1998.  3:12:39", "%d.%m.%Y.") , STR_TO_DATE("16.10.1995.  2:37:37", "%d.%m.%Y.") , 30 , ),
 ( 1194 , STR_TO_DATE("6.4.1999.  1:53:1", "%d.%m.%Y.") , STR_TO_DATE("24.8.1994.  17:13:30", "%d.%m.%Y.") , 17 , ),
 ( 1195 , STR_TO_DATE("13.2.1991.  6:30:50", "%d.%m.%Y.") , STR_TO_DATE("10.3.1999.  23:18:35", "%d.%m.%Y.") , 46 , ),
 ( 1196 , STR_TO_DATE("28.10.1994.  21:13:0", "%d.%m.%Y.") , STR_TO_DATE("13.10.1992.  13:21:47", "%d.%m.%Y.") , 22 , ),
 ( 1197 , STR_TO_DATE("15.12.1999.  10:8:60", "%d.%m.%Y.") , STR_TO_DATE("5.4.1998.  1:46:44", "%d.%m.%Y.") , 40 , ),
 ( 1198 , STR_TO_DATE("4.9.2000.  6:42:53", "%d.%m.%Y.") , STR_TO_DATE("20.6.1993.  7:38:53", "%d.%m.%Y.") , 16 , ),
 ( 1199 , STR_TO_DATE("4.8.1997.  16:42:15", "%d.%m.%Y.") , STR_TO_DATE("3.9.1992.  9:4:47", "%d.%m.%Y.") , 24 , );
