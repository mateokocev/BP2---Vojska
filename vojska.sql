...
INSERT INTO osoblje VALUES
 ...
 ( 10999 , 3 , "admin" , "admin" , "General" , STR_TO_DATE("4.9.1955.", "%d.%m.%Y.") , STR_TO_DATE("24.11.1995.", "%d.%m.%Y.") , "Pokojan u duši" , "A+" , 3);
...
INSERT INTO misija VALUES
 ...
 ( 3008 , "Jadran" , STR_TO_DATE("27.10.2012.", "%d.%m.%Y.") , STR_TO_DATE("24.8.2013.", "%d.%m.%Y.") , 28 , 3 ,"Operacija Jadran je bila vojna misija u kojoj su vojne snage bile uključene u borbu protiv piratizma u regiji Jadrana. Cilj misije bio je osiguravanje sigurnosti na moru i sprječavanje terorističkih aktivnosti u regiji. " , 6807180 ),
 ( 3009 , "Ponos" , STR_TO_DATE("15.12.2010.", "%d.%m.%Y.") , STR_TO_DATE("23.10.2013.", "%d.%m.%Y.") , 27 , 10 ,"Misija Ponos bila je vojna misija u Bosni i Hercegovini. Cilj misije bio je pružiti podršku i pomoć međunarodnim snagama koje su bile poslane u Bosnu i Hercegovinu u svrhu održavanja mira i stabilnosti u regiji.  Misija Ponos bila je jedna od najvećih međunarodnih vojnih misija u Bosni i Hercegovini, a trajala je više od deset godina." , 2975836 ),
 ( 3010 , "Mornar" , STR_TO_DATE("22.6.2019.", "%d.%m.%Y.") , STR_TO_DATE("18.1.2020.", "%d.%m.%Y.") , 41 , 8 ,"Vojna misija Mornar je bila operacija koja se odvijala u periodu od 2010. do 2012. godine. Cilj misije bio je osigurati sigurnost tajvanske teritorijalne vode u Južnom Kineskom moru i spriječiti piratstvo u tom području." , 8709357 ),
 ( 3011 , "Sokol" , STR_TO_DATE("5.10.2015.", "%d.%m.%Y.") , STR_TO_DATE("22.1.2016.", "%d.%m.%Y.") , 20 , 11 ,"Misija Sokol je bila vojna akcija koja je imala za cilj da spriječi ulazak ilegalnih oružanih grupa u zemlju i da zaštiti nacionalnu sigurnost i teritorijalni integritet države. Ova misija je također imala za cilj da spriječi širenje kriminala i nasilja na granici sa susjednim zemljama. " , 9916296 ),
 ( 3012 , "Zlatni ljiljan" , STR_TO_DATE("24.12.2012.", "%d.%m.%Y.") , STR_TO_DATE("30.12.2012.", "%d.%m.%Y.") , 31 , 14 , "Zlatni ljiljan je trening misija koju organizira američka vojska. Cilj misije je pružiti visokokvalitetno obrazovanje i trening vojnicima kako bi se osigurala njihova spremnost za buduće operacije. Trening se obično održava na vojnim bazama u različitim dijelovima zemlje i uključuje različite vježbe i simulirane scenarije koji se temelje na realnim operacijama. ", 5019551 ), 
 ( 3013 , "Javor" , STR_TO_DATE("17.3.2014.", "%d.%m.%Y.") , STR_TO_DATE("14.11.2014.", "%d.%m.%Y.") , 32 , 4 ,"Javor je bio terenska misija koja se održavala unutar Poljske. Cilj misije je bio da se osigura da vojnici budu spremni za različite vrste operacija u različitim okruženjima. Treninzi su uključivali fizičke vježbe upoznavanje sa oružjem i opremom. Ceijela operacija je provedena kako bi se steklo iskustvo u međunarodnim operacijama ." , 2062168 ),
 ( 3014 , "Pobjeda" , STR_TO_DATE("26.11.2009.", "%d.%m.%Y.") , STR_TO_DATE("7.1.2010.", "%d.%m.%Y.") , 21 , 9 ,"Operacija Pobjeda bila je vojna misija koja je provođena unutar Južne Koreje. Cilj misije bio je osigurati mir i stabilnost u zemlji kao i zaštititi južnokorejske interese i građane od prijetnji sjevernokorejskog režima. Misija je obuhvatala različite aktivnosti uključujući obuku vojnika izgradnju i održavanje vojne infrastrukture, te pružanje podrške civilnom stanovništvu." , 8728552 ),
 ( 3015 , "Vojnik" , STR_TO_DATE("8.8.2014.", "%d.%m.%Y.") , STR_TO_DATE("7.7.2015.", "%d.%m.%Y.") , 23 , 4 ,"Trening misija vojnika u Poljskoj bila je namijenjena vojnicima koji su se željeli pripremiti za buduće vojne operacije. Cilj je bio usavršiti vojne vještine i taktike kao i rad u timu i pod stresom. Trening se odvijao na poljskoj vojnoj bazi i obuhvaćao je različite vježbe uključujući i one u terenskim uvjetima.", 3318084 ),
 ( 3016 , "Narodna odbrana" , STR_TO_DATE("10.6.2019.", "%d.%m.%Y.") , STR_TO_DATE("21.8.2019.", "%d.%m.%Y.") , 34 , 8 ,"Trening misija narodna obrana je program obuke koji se provodi unutar Tajvana sa ciljem da se formira i osposobi nacionalna obrambena snaga koja će biti sposobna da zaštiti državu od vanjskih prijetnji. Ovaj program obuhvata različite vrste treninga uključujući fizičku pripremu obuku oružja i taktiku kao i obuku za rad u timu i postizanje ciljeva." , 1692847 ),
 ( 3017 , "Vukovi" , STR_TO_DATE("17.12.2016.", "%d.%m.%Y.") , STR_TO_DATE("14.3.2017.", "%d.%m.%Y.") , 39 , 12 ,"Trening misija Vukovi je bila vojna vježba koja je održana unutar granica Norveške. Cilj misije je bio da se vojnici pripreme za različite vrste oružanih sukoba u hladnom i planinskom terenu. Vojnici su prošli kroz različite scenario-based treninge uključujući i borbu u snijegu i ledu kao i obuku u upotrebi različitih vrsta oružja i opreme za preživljavanje u teškim uvjetima. " , 8843818 ),
 ( 3018 , "Orkan" , STR_TO_DATE("4.8.2014.", "%d.%m.%Y.") , STR_TO_DATE("20.2.2015.", "%d.%m.%Y.") , 27 , 4 ,"Trening misija Orkan u Poljskoj bila je trening misija koja je obuhvatila višednevne treninge za poljske vojne snage. Cilj ove misije bio je da se poljski vojnici spreme za buduće operacije u zahtjevnim okruženjima kao što su ratna zona ili područja s visokim rizikom od prirodnih katastrofa." , 3493087 ),
 ( 3019 , "Velikanka" , STR_TO_DATE("23.3.2022.", "%d.%m.%Y.") , STR_TO_DATE("3.5.2022.", "%d.%m.%Y.") , 34 , 5 ,"Vojna misija Velikanka unutar Ukrajine je bila usmjerena na podršku ukrajinskoj vladi u njenoj borbi protiv proruskih snaga. Velikanka je poslala svoje vojnike da pomognu pri stecanju mira i stabilnosti u područjima koja su bila izložena sukobima te da pruže humanitarnu pomoć lokalnom stanovništvu.", 2149934 ),
 ( 3020 , "Slavonska krila" , STR_TO_DATE("1.6.2009.", "%d.%m.%Y.") , STR_TO_DATE("1.12.2020.", "%d.%m.%Y.") , 28 , 1 ,"Vojna misija Slavonska krila unutar Indije i Pakistana bila je usmjerena na pružanje podrške i pomoć u stabilizaciji ovih zemalja nakon dugotrajnih sukoba i nestabilnosti. Misija je uključivala pomoć u obnovi infrastrukture pružanje humanitarne pomoći i pružanje sigurnosti lokalnom stanovništvu. " , 5557034 ),
 ( 3021 , "Jedinstvo" , STR_TO_DATE("6.7.2016.", "%d.%m.%Y.") , STR_TO_DATE("23.2.2018.", "%d.%m.%Y.") , 21 , 12 ,"Trening misija Jedinstvo unutar Norveške je bila usmjerena na jačanje međusobne suradnje i povezanosti među članovima norveške vojske te poboljšanje njihovih taktičkih i tehničkih sposobnosti." , 4525460 ),
 ( 3022 , "Čardak" , STR_TO_DATE("2.11.2013.", "%d.%m.%Y.") , STR_TO_DATE("14.8.2014.", "%d.%m.%Y.") , 41 , 7 ,"Trening misija Čardak u Južnoj Africi predstavlja važnu inicijativu za razvoj i unapređenje vojnih sposobnosti južnoafričkih vojnika. Ova misija se fokusira na obuku vojnika u modernim taktičkim tehnikama i tehnologijama kao i na podizanje njihove fizičke spremnosti i mentalne izdržljivosti. Cilj ovog treninga je da se formira elitna vojna jedinica koja će biti spremna da se suoči sa izazovima na terenu i da pruži efikasnu zaštitu za stanovnike Južne Afrike. ", 4644302 ),
 ( 3023 , "Sokolsko pero" , STR_TO_DATE("7.12.2016.", "%d.%m.%Y.") , STR_TO_DATE("15.3.2017.", "%d.%m.%Y.") , 27 , 11 , "Vojna misija Sokolsko pero unutar Venezuele bila je odlučna akcija koja je imala za cilj da pomogne u stabilizaciji političke situacije u zemlji. Vojni kontingent Sokolsko pero koji je sastavljen od visoko obučenih i sposobnih vojnika bio je odgovoran za borbu protiv terorizma i održavanje mira u regiji. Misija je također podržavala humanitarne napore i pomogla u očuvanju sigurnosti građana Venezuele.", 6720729 ),
 ( 3024 , "Branitelj" , STR_TO_DATE("21.3.2017.", "%d.%m.%Y.") , STR_TO_DATE("19.3.2018.", "%d.%m.%Y.") , 26 , 12 ,"Trening vojne misije branitelj u Norveškoj je program koji priprema vojnike za rad u međunarodnim vojnim operacijama u cilju očuvanja mira i stabilnosti. Ovi treningi se obično odvijaju u vojnim bazama u Norveškoj i uključuju fizičke i teorijske vježbe koje pomažu vojnicima da se pripreme za različite vrste zadataka koji mogu naići tijekom misije. Trening također uključuje poduku o kulturnim razlikama i načinima komuniciranja s lokalnom populacijom kao i o sigurnosnim mjerama koje treba poduzeti tijekom misije." , 2760791 ),
 ( 3025 , "Snažan udar" ,STR_TO_DATE("9.8.2017.", "%d.%m.%Y.") , STR_TO_DATE("11.1.2018.", "%d.%m.%Y.") , 20 , 12 ,"Trening vojne misije Snažan udar u Norveškoj je bio izuzetno zahtjevan i namjenjen je pripremi vojnika za specijalne zadatke. Ovaj trening je obuhvatio fizičke i tehničke vježbe kao i obuku u upotrebi oružja i opreme. Cilj ovog treninga je bio da se pripreme vojnici za uspješno izvršavanje misije u Norveškoj gdje su imali zadatak da osiguraju stabilnost u regionu.", 2505324 ),
 ( 3026 , "Vukovi sa Vlašića" , STR_TO_DATE("23.5.2006.", "%d.%m.%Y.") , STR_TO_DATE("20.1.2007.", "%d.%m.%Y.") , 34 , 13 , 'Vukovi sa Velebita su hrvatska vojna jedinica koja se bavi treningom vojnih misija. Ova jedinica se sastoji od iskusnih i stručnih vojnika koji su prošli rigorozne obuke i testiranja. Oni su specijalizirani za izvedbu različitih vrsta vojnih misija uključujući protivterorističke protivdiverzantske i protivnapadne operacije. Trening vojne misije Vukova sa Velebita u švicarskoj obuhvaća različite scenarije i situacije kako bi se osiguralo da su vojnici spremni za svaku eventualnost u stvarnim misijama. Trening se odvija u realističnim okolnostima i uključuje korištenje napredne opreme i tehnologije. Cilj treninga je osigurati da vojnici budu spremni za svaku vrstu vojne misije i da mogu izvesti svoje zadatke na siguran i učinkovit način.', 8658669 ),
 ( 3027 , "Pustinjski oluj" , STR_TO_DATE("10.12.2012.", "%d.%m.%Y.") , STR_TO_DATE("24.1.2013.", "%d.%m.%Y.") , 17 , 14 ,"Pustinjski oluj je vojna misija koja se odvija u SAD-u i koja se fokusira na trening za borbu u pustinjskim uvjetima. Vojnici se treniraju za različite vrste operacija kao što su preživljavanje pregrupisavanje i borba u uvjetima visokih temperatura i suše. Trening uključuje korišćenje specijalizovane opreme i taktike kao i rad u timu sa drugim jedinicama. Cilj ovog treninga je da se vojnici pripreme za eventualne operacije u pustinjskim uslovima kako bi bili spremni da izvrše svoje dužnosti i da prežive u ovom teškom okruženju." , 2674440 ),
 ( 3028 , "Neprekidni lancevi" , STR_TO_DATE("14.3.2010.", "%d.%m.%Y.") , STR_TO_DATE("8.6.2011.", "%d.%m.%Y.") , 18 , 6 , 'Neprekidni lancevi je vojna misija koja se odvijala u Afganistanu u drugoj turi. Cilj misije je bio osigurati stabilnost i sigurnost u regiji te osnažiti afganistanske snage sigurnosti kako bi same mogle osiguravati sigurnost u zemlji. Misija je obuhvaćala obuku savjetovanje i podršku afganistanskim snagama sigurnosti kao i provođenje ciljanih operacija protiv talibanskih pobunjenika. Misija je trajala od 2010. do 2014. godine.', 8566407 ),
 ( 3029 , "Obrana demokracije" , STR_TO_DATE("25.5.2016.", "%d.%m.%Y.") , STR_TO_DATE("11.1.2017.", "%d.%m.%Y.") , 21 , 12 , 'Trening vojne misije Obrana demokracije u Norveškoj je program za obuku vojnika koji se fokusira na obranu demokratskih vrijednosti i principa u slučaju potencijalnog napada na Europsku uniju. Vojska će se obučavati u različitim scenarijima uključujući i one koji se odnose na prijetnje od terorizma i cyber napada. Cilj je osposobiti vojnike da budu spremni za svaku situaciju i da brzo i efikasno reagiraju u slučaju potrebe. Trening će uključivati i suradnju s drugim nacionalnim i međunarodnim snagama.', 8550255 ),
 ( 3030 , "Zaljevska obrana" , STR_TO_DATE("14.7.2022.", "%d.%m.%Y.") , STR_TO_DATE("27.9.2022.", "%d.%m.%Y.") , 19 , 5 , 'Vojna misija Zaljevska obrana u Ukrajini je operacija Europske unije koja se bavi osiguravanjem sigurnosti i stabilnosti na obali Crnog mora. Uključuje kombinaciju vojnih i civilnih aktivnosti kako bi se osigurala sigurnost pomorskih komunikacija i sprječile moguće napade na Ukrajinsku obalu. Ova misija također ima za cilj pružanje podrške Ukrajini u borbi protiv terorizma i kriminala na moru. Uključuje učešće više zemalja članica EU i suradnju sa Ukrajinskim vlastima.', 9865296 ),
 ( 3031 , "Afrička sloboda" , STR_TO_DATE("21.10.2008.", "%d.%m.%Y.") , STR_TO_DATE("11.11.2008.", "%d.%m.%Y.") , 29 , 2 , 'Afrička sloboda je vojna misija koja se provodi u Afganistanu sa ciljem stabilizacije i unapređenja sigurnosti u zemlji. Misija je podržana od strane Europske unije i uključuje trupe iz različitih afričkih zemalja kao i europskih sila. Cilj misije je da se podrži afganistanska vlada u borbi protiv terorizma i da se pomogne u izgradnji stabilne i sigurne države. Misija takođe uključuje i pomoć u razvoju i poboljšanju životnih uvjeta stanovništva.', 7109438 ),
 ( 3032 , "Vjetar u leđa" , STR_TO_DATE("12.3.2022.", "%d.%m.%Y.") , STR_TO_DATE("2.8.2022.", "%d.%m.%Y.") , 27 , 5 ,'Vojna misija "Vjetar u leđa" u Ukrajini je operacija koja se provodi u suradnji s NATO-om i cilj joj je osnaživanje sigurnosnih snaga Ukrajine u borbi protiv proruskih separatističkih snaga. Ova misija uključuje vojne savjetnike i obuku ukrajinskih vojnika kao i pružanje logističke podrške i opremu. Cilj misije je jačanje stabilnosti i sigurnosti u Ukrajini te pružanje podrške ukrajinskim naporima za očuvanje suvereniteta i teritorijalnog integriteta.' , 1903659 ),
 ( 3033 , "Neprijatelj na vrhu" , STR_TO_DATE("2.11.2006.", "%d.%m.%Y.") , STR_TO_DATE("24.2.2007.", "%d.%m.%Y.") , 17 , 13 ,'Trening vojna misija "Neprijatelj na vrhu" u Švicarskoj je intenzivna taktička vježba koja se fokusira na pripremu vojnika za borbu u alpskom okruženju. Vojnici će se suočiti s različitim izazovima poput prelaska preko ledenjaka borbe u uskim dolinama i korištenja specijalizirane opreme za alpsko ratovanje. Cilj je osposobiti vojnike za rad u teškim i izazovnim uvjetima kao i poboljšati njihove taktičke sposobnosti i koordinaciju u timu.' , 611531 ),
 ( 3034 , "Vatreni val" , STR_TO_DATE("25.5.2010.", "%d.%m.%Y.") , STR_TO_DATE("22.7.2012.", "%d.%m.%Y.") , 20 , 6 , 'Trening vojna misija "Neprijatelj na vrhu" u Švicarskoj je intenzivna taktička vježba koja se fokusira na pripremu vojnika za borbu u alpskom okruženju. Vojnici će se suočiti s različitim izazovima poput prelaska preko ledenjaka borbe u uskim dolinama i korištenja specijalizirane opreme za alpsko ratovanje. Cilj je osposobiti vojnike za rad u teškim i izazovnim uvjetima kao i poboljšati njihove taktičke sposobnosti i koordinaciju u timu.', 3860340 ),
 ( 3035 , "Posljednja šansa" , STR_TO_DATE("19.7.2014.", "%d.%m.%Y.") , STR_TO_DATE("3.11.2014.", "%d.%m.%Y.") , 24 , 7 ,'Trening vojna misija Posljednja šansa u južnoj Africi je napredni trening za vojnike koji se pripremaju za izazove i opasnosti koje se mogu susresti u južnoafričkim ratištima. Ovaj treninzi se fokusira na taktičke i operativne vještine kao i na suradnju i komunikaciju unutar postrojbe. Vojnici će se suočiti s različitim scenarijima i situacijama kao što su borba u urbanom okruženju evakuacija civila i spašavanje ranjenika. Cilj ovog treninga je da pripremi vojnike za realne situacije i osigura da su spremni za svaku misiju u južnoafričkom kontekstu' , 5264104 ),
 ( 3036 , "Konačni susret" , STR_TO_DATE("24.10.2010.", "%d.%m.%Y.") , STR_TO_DATE("28.12.2010.", "%d.%m.%Y.") , 36 , 3 ,'Trening vojna misija "Konačni susret" u Grčkoj je intenzivni tjedni program za vojnike koji se fokusira na osposobljavanje za bojne situacije u urbanom okruženju. Vojnici će se suočiti sa različitim scenarijima uključujući razminiranje borbu protiv terorista i spašavanje civila. Osim fizičkih vježbi. Vojnici će također proći kroz tečajeve za rukovanje oružjem i taktičku komunikaciju. Cilj treninga je da se vojnici osposobe za uspješno izvršavanje misija u različitim okruženjima i da se poboljša njihova sposobnost da reagiraju na izazove u boju.' , 473290 ),
 ( 3037 , "Povratak kući" , STR_TO_DATE("19.11.2010.", "%d.%m.%Y.") , STR_TO_DATE("26.12.2010.", "%d.%m.%Y.") , 30 , 10 , 'Trening vojna misija Povratak kući u Bosni i Hercegovini je program za vojnike koji se fokusira na pripremu za izazove koji se mogu pojaviti tokom misije u Bosni i Hercegovini. Ovaj trening obuhvaća različite vještine i tehnike uključujući komunikaciju sa lokalnim stanovništvom rukovođenje patrolama rješavanje incidenta i drugo. Cilj ovog treninga je da se vojnici osposobe za rad u složenim i nestabilnim okruženjima te da budu spremni za svaki eventualni scenario koji se može pojaviti tokom misije.' , 7519572 ),
 ( 3038 , "Vatreno olujno nebo" , STR_TO_DATE("9.9.2008.", "%d.%m.%Y.") , STR_TO_DATE("11.9.2010.", "%d.%m.%Y.") , 24 , 1 , 'Vatreno olujno nebo je vojna misija koja se odvija u Indiji i Pakistanu. Cilj misije je da se osposobi vojnici za rad u teškim i napetim okolnostima kao što su sukobi sa neprijateljem i prirodne katastrofe. Trening uključuje različite vježbe poput borbe u urbanom okruženju spašavanja u katastrofama i rada u skupinama. Vojnici se također osposobljavaju za rad sa različitim vrstama oružja i vojne opreme. Ova misija je važna za osiguranje sigurnosti i stabilnosti u regiji.', 9840396 ), 
 ( 3039 , "Konačno pobjedništvo" , STR_TO_DATE("30.9.2015.", "%d.%m.%Y.") , STR_TO_DATE("13.1.2016.", "%d.%m.%Y.") , 28 , 11 ,'Vojna misija "Konačno pobjedništvo u Venezueli" je operacija koja se fokusira na svrgavanje vladajućeg režima u Venezueli i instaliranje nove vlade koja će se pridržavati demokratskih principa i ljudskih prava. Misija se sastoji od kombinacije vojnih napada specijalnih operacija i humanitarnih aktivnosti kako bi se osigurala sigurnost civila i pružila pomoć onima koji su pogođeni krizom. Cilj misije je ukloniti diktatorsku vlast i postići konačno pobjedništvo za narod Venezuele.' , 9966801 ),
 ( 3040 , "Krvavo nebo" , STR_TO_DATE("16.11.2019.", "%d.%m.%Y.") , STR_TO_DATE("28.12.2019.", "%d.%m.%Y.") , 36 , 8 ,'Trening zrakoplovne vojne misije Krvavo nebo u Taiwanu je specijalizirani program koji se temelji na simulaciji i stvarnim scenarijima ratnih operacija. Cilj ovog treninga je osnaživanje vojnih snaga Taiwana u obrani protiv mogućeg napada s Kine. Vojni piloti i drugi vojni zrakoplovni stručnjaci uče kako upravljati i koristiti različite vrste zrakoplova kao i kako izvoditi različite taktičke manevre. Trening također uključuje rad u timu i suradnju s drugim vojnim jedinicama. Ova misija je važna za sigurnost Taiwana i njegove vojne sposobnosti.' , 172465 ),
 ( 3041 , "Smrtni huk" , STR_TO_DATE("26.2.2022.", "%d.%m.%Y.") , STR_TO_DATE("16.8.2022.", "%d.%m.%Y.") , 22 , 5 , 'Vojna misija Smrtni huk je bila operacija koja se odvijala u Ukrajini a cilj joj je bio osigurati mir i stabilnost na području koje je bilo pogođeno sukobima između ukrajinskih snaga i proruskih separatističkih grupa. Misija je započela u siječnju 2015. godine i trajala je do lipnja 2016. godine. Uključivala je više od 10.000 vojnika iz različitih zemalja uključujući Sjedinjene Države Veliku Britaniju Poljsku i druge. Cilj misije bio je osigurati sigurnost civila i pružiti podršku ukrajinskim snagama u borbi protiv separatističkih skupina. Misija je bila uspješna u smanjenju nasilja i pružanju podrške civilima ali sukobi su se nastavili i dalje.', 7220839 ),
 ( 3042 , "Svjetlo na kraju tunela" , STR_TO_DATE("11.12.2019.", "%d.%m.%Y.") , STR_TO_DATE("28.6.2020.", "%d.%m.%Y.") , 33 , 8 ,"Trening vojne misije Svjetlo na kraju tunela u Taiwanu je program koji se sastoji od različitih fizičkih i taktičkih vježbi koji se provode u različitim uvjetima. Cilj treninga je pripremiti vojnike za potencijalnu misiju u Taiwanu gdje bi se suočili s različitim izazovima poput visokih temperatura teškog terena i mogućeg sukoba. Vojnici se treniraju za različite situacije uključujući borbu u urbanom okruženju preživljavanje u divljini i borbu protiv neprijatelja. Trening se provodi pod vodstvom iskusnih instruktora i koristi se moderna oprema i tehnologija." , 3998984 ),
 ( 3043 , "Konačna pobjeda" , STR_TO_DATE("19.1.2011.", "%d.%m.%Y.") , STR_TO_DATE("4.1.2012.", "%d.%m.%Y.") , 40 , 6 ,"Trening vojne misije Konačna pobjeda u 2. Afganistanskoj turi fokusira se na osnaživanje sposobnosti vojnika za izvođenje operacija u zahtjevnom ratnom okruženju. Vojnici prolaze kroz intenzivne fizičke i taktičke treninge kako bi se pripremili za borbu protiv talibana i drugih extremističkih skupina. Osim toga vojnici se također obučavaju u komunikaciji i suradnji s afganistanskim snagama sigurnosti te u humanitarnim misijama i kontaktu s lokalnom zajednicom. Cilj ovog treninga je osigurati konačnu pobjedu u Afganistanu kroz jačanje sposobnosti vojnika i podršku afganistanskim snagama sigurnosti." , 6122253 ),
 ( 3044 , "Zmajevi u nebu" , STR_TO_DATE("12.9.2011.", "%d.%m.%Y.") , STR_TO_DATE("20.3.2012.", "%d.%m.%Y.") , 31 , 10 ,"Trening Zmajevi u nebu je vojna misija koja se odvija u Bosni i Hercegovini. Cilj treninga je da se vojnici osposobe za izvođenje misija u zemljama u tranziciji. Trening obuhvata različite vježbe uključujući letenje helikoptera upotrebu oružja i taktičko djelovanje u različitim scenarijima. Vojnici se također osposobljavaju za rad u međunarodnim okruženjima i razumijevanje kulture i običaja zemlje u kojoj se nalaze. Trening Zmajevi u nebu je važan dio pripreme vojnika za izvođenje misija u zemljama u tranziciji." , 3957457 ),
 ( 3045 , "Zlatna kugla" , STR_TO_DATE("21.7.2006.", "%d.%m.%Y.") , STR_TO_DATE("15.7.2008.", "%d.%m.%Y.") , 16 , 13 ,"Trening vojne misije Zlatna kugla u Švicarskoj je specijalizirani program koji se fokusira na trening vojnih snaga za specijalne operacije. Cilj treninga je poboljšati sposobnost vojnika za izvršenje zadataka u različitim taktičkim situacijama kao što su antiterorističke operacije spašavanje talaca i borba protiv neprijatelja u urbanom okruženju. Program uključuje fizičke i taktičke vježbe kao i obuku u korištenju različitih oružja i opreme. Švicarska se smatra jednim od najboljih mjesta za ovakav trening zbog svoje geografske pozicije i visokog stupnja sigurnosti." , 1087331 ),
 ( 3046 , "Vatreni stihovi" , STR_TO_DATE("8.4.2016.", "%d.%m.%Y.") , STR_TO_DATE("28.5.2017.", "%d.%m.%Y.") , 36 , 11 ,"Vatreni stihovi je vojna misija koja se odvija u Venezueli. Cilj misije je osigurati sigurnost i stabilnost u zemlji kao i podržati vladu u borbi protiv terorizma i kriminala. Misija uključuje različite operacije od patroliranja gradova i ruralnih područja do antiterorističkih akcija i potpore lokalnim snagama reda. Vojnici su uključeni u treniranje i obuku lokalnih snaga kao i u pružanje humanitarne pomoći stanovništvu. Misija Vatreni stihovi je važan dio globalne borbe protiv terorizma i kriminala te je važna za očuvanje sigurnosti i stabilnosti u regiji." , 853626 ),
 ( 3047 , "Odlučujući okršaj" , STR_TO_DATE("24.12.2009.", "%d.%m.%Y.") , STR_TO_DATE("1.10.2010.", "%d.%m.%Y.") , 25 , 9 , "Mirovna vojna misija u Južnoj Koreji ima za cilj razrješavanje dugogodišnjeg sukoba između Južne i Sjeverne Koreje. Trenutačna situacija uključuje stalne napetosti i prijetnje te je potreban hitan intervencija kako bi se spriječile daljnje žrtve i širenje rata. Mirovna misija se sastoji od diplomatskih pregovora i dogovora te moguće prisilne intervencije ako se situacija ne popravi. Odlučujući okršaj bi mogao biti ključni trenutak u razrješavanju konflikta te je važno da se sve strane zauzmu za mirno rješenje.", 6286138 ),
 ( 3048 , "Pobjednički pohod" , STR_TO_DATE("17.11.2010.", "%d.%m.%Y.") , STR_TO_DATE("3.5.2012.", "%d.%m.%Y.") , 40 , 10 , "Trening vojna misija Pobjednički pohod u Bosni i Hercegovini je bila usmjerena na osnaživanje i unapređenje sposobnosti vojnih jedinica u Bosni i Hercegovini. Cilj misije bio je osigurati stabilnost i mir u zemlji te pružiti podršku lokalnim vlastima u sprečavanju oružanih sukoba. Vojnici su prošli kroz različite vježbe i treninge koji su ih pripremili za različite scenarije uključujući humanitarnu pomoć spašavanje i ciljano djelovanje. Misija je bila uspješna u osiguravanju stabilnosti i mira u Bosni i Hercegovini te je doprinijela unapređenju sposobnosti lokalnih snaga sigurnosti." , 8778437 ),
 ( 3049 , "Smrtni cilj" , STR_TO_DATE("22.9.2010.", "%d.%m.%Y.") , STR_TO_DATE("7.11.2012.", "%d.%m.%Y.") , 21 , 1 , "Mirovna vojna misija u Indiji i Pakistanu ima za cilj rješavanje dugogodišnjeg sukoba između dvije zemlje oko podjele teritorija i statusa regije Kašmira. Cilj misije je preustrojiti odnose između Indije i Pakistanu kroz dijalog i pregovore te postići trajni mir i stabilnost u regiji. Misija također ima za cilj poboljšanje života stanovništva u Kašmiru kroz razvoj i poboljšanje standarda života.", 6568915 ),
 ( 3050 , "Oluja neba" , STR_TO_DATE("11.5.2013.", "%d.%m.%Y.") , STR_TO_DATE("14.8.2013.", "%d.%m.%Y.") , 24 , 14 ,"Trening vojne misije Oluja neba u SAD je trenažni program koji se fokusira na taktičko i operativno obučavanje vojnika za vojne misije u zrakoplovstvu. Ova misija se sastoji od niza trenažnih aktivnosti koje uključuju letove u zrakoplovima borbeno treniranje i simulacije ratnih scenarija. Cilj ovog programa je osposobiti vojnike za uspješno izvršavanje zadataka u zrakoplovstvu te poboljšati njihove sposobnosti za rad u timu i pod stresom." , 8606804 );
...
INSERT INTO popravak VALUES
 ...
 ( 6002 , 9018 , "Potrebni mali popravci" , STR_TO_DATE("14.11.2021.", "%d.%m.%Y.") , STR_TO_DATE("25.3.2026.", "%d.%m.%Y.") , 429969 ),
 ( 6003 , 9005 , "Popravci na rubu neisplativosti" , STR_TO_DATE("9.3.1993.", "%d.%m.%Y.") , STR_TO_DATE("12.12.2023.", "%d.%m.%Y.") , 374594 ),
 ( 6004 , 9006 , "Popravci na rubu neisplativosti" , STR_TO_DATE("10.2.2024.", "%d.%m.%Y.") , STR_TO_DATE("24.3.2025.", "%d.%m.%Y.") , 303429 ),
 ( 6005 , 9009 , "Vozilu je potrebna kompletna restauracija" , STR_TO_DATE("14.10.2015.", "%d.%m.%Y.") , STR_TO_DATE("19.1.2016.", "%d.%m.%Y.") , 299849 ),
 ( 6006 , 9003 , "Popravci na rubu neisplativosti" , STR_TO_DATE("22.7.2007.", "%d.%m.%Y.") , STR_TO_DATE("17.12.2018.", "%d.%m.%Y.") , 472183 ),
 ( 6007 , 9017 , "Manja šteta na oklopu i manji popravci" , STR_TO_DATE("25.12.2017.", "%d.%m.%Y.") , STR_TO_DATE("23.9.2018.", "%d.%m.%Y.") , 345516 ),
 ( 6008 , 9003 , "Popravci na rubu neisplativosti" , STR_TO_DATE("18.3.2004.", "%d.%m.%Y.") , STR_TO_DATE("3.7.2005.", "%d.%m.%Y.") , 339466 ),
 ( 6009 , 9016 , "Vozilo nije u voznome stanju" , STR_TO_DATE("5.3.2004.", "%d.%m.%Y.") , STR_TO_DATE("11.8.2006.", "%d.%m.%Y.") , 202165 ),
 ( 6010 , 9012 , "Vozilo nije u voznome stanju" , STR_TO_DATE("18.8.1996.", "%d.%m.%Y.") , STR_TO_DATE("2.12.2019.", "%d.%m.%Y.") , 247772 ),
 ( 6011 , 9019 , "Popravci na rubu neisplativosti" , STR_TO_DATE("23.6.2000.", "%d.%m.%Y.") , STR_TO_DATE("18.7.2005.", "%d.%m.%Y.") , 253430 ),
 ( 6012 , 9003 , "Vozilu je potrebna kompletna restauracija" , STR_TO_DATE("14.9.2020.", "%d.%m.%Y.") , STR_TO_DATE("7.9.2021.", "%d.%m.%Y.") , 267460 ),
 ( 6013 , 9005 , "Popravci na rubu neisplativosti" , STR_TO_DATE("13.2.1997.", "%d.%m.%Y.") , STR_TO_DATE("17.6.1999.", "%d.%m.%Y.") , 367066 ),
 ( 6014 , 9006 , "Manja šteta na oklopu i manji popravci" , STR_TO_DATE("20.10.2001.", "%d.%m.%Y.") , STR_TO_DATE("6.9.2004.", "%d.%m.%Y.") , 356967 ),
 ( 6015 , 9007 , "Popravci na rubu neisplativosti" , STR_TO_DATE("13.8.2004.", "%d.%m.%Y.") , STR_TO_DATE("8.2.2005.", "%d.%m.%Y.") , 482278 ),
 ( 6016 , 9020 , "Potrebni mali popravci" , STR_TO_DATE("1.9.2008.", "%d.%m.%Y.") , STR_TO_DATE("28.5.2011.", "%d.%m.%Y.") , 324646 ),
 ( 6017 , 9018 , "Vozilo nije u voznome stanju" , STR_TO_DATE("28.10.2021.", "%d.%m.%Y.") , STR_TO_DATE("21.2.2027.", "%d.%m.%Y.") , 220281 ),
 ( 6018 , 9006 , "Manja šteta na oklopu i manji popravci" , STR_TO_DATE("9.1.1993.", "%d.%m.%Y.") , STR_TO_DATE("12.12.1994.", "%d.%m.%Y.") , 213060 ),
 ( 6019 , 9004 , "Potrebni mali popravci" , STR_TO_DATE("14.3.2006.", "%d.%m.%Y.") , STR_TO_DATE("1.2.2007.", "%d.%m.%Y.") , 277448 ),
 ( 6020 , 9016 , "Popravci na rubu neisplativosti" , STR_TO_DATE("3.2.2019.", "%d.%m.%Y.") , STR_TO_DATE("5.12.2020.", "%d.%m.%Y.") , 441037 );
...
INSERT INTO trening VALUES
 ( 1100 , STR_TO_DATE("20.7.1990.  4:9:55", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("14.7.1991.  2:14:36", "%d.%m.%Y. %H:%i:%s") , 35),
 ...
 ( 1103 , STR_TO_DATE("9.6.1992.  23:25:56", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("22.4.1993.  23:23:29", "%d.%m.%Y. %H:%i:%s") , 23),
 ( 1104 , STR_TO_DATE("19.11.1993.  4:43:36", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("25.10.1999.  17:37:18", "%d.%m.%Y. %H:%i:%s") , 39),
 ( 1105 , STR_TO_DATE("5.8.1990.  19:35:30", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("13.8.1991.  11:25:21", "%d.%m.%Y. %H:%i:%s") , 25),
 ( 1106 , STR_TO_DATE("19.1.1996.  12:5:20", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("22.10.1998.  20:43:49", "%d.%m.%Y. %H:%i:%s") , 21),
 ( 1107 , STR_TO_DATE("2.5.1991.  11:18:29", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("19.1.1992.  22:23:59", "%d.%m.%Y. %H:%i:%s") , 38),
 ( 1108 , STR_TO_DATE("1.1.1990.  23:42:3", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("28.8.1992.  10:30:35", "%d.%m.%Y. %H:%i:%s") , 34),
 ( 1109 , STR_TO_DATE("21.6.1993.  23:55:36", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("1.6.1994.  14:56:42", "%d.%m.%Y. %H:%i:%s") , 30),
 ( 1110 , STR_TO_DATE("20.1.1992.  1:37:10", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("7.1.2000.  18:45:6", "%d.%m.%Y. %H:%i:%s") , 40),
 ( 1111 , STR_TO_DATE("12.8.1990.  19:48:17", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("21.9.1991.  15:4:3", "%d.%m.%Y. %H:%i:%s") , 29),
 ...
 ( 1114 , STR_TO_DATE("21.11.1990.  16:23:43", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("12.4.1992.  22:10:22", "%d.%m.%Y. %H:%i:%s") , 29),
 ...
 ( 1117 , STR_TO_DATE("18.1.1994.  19:16:34", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("1.10.1996.  12:37:13", "%d.%m.%Y. %H:%i:%s") , 41),
 ...
 ( 1120 , STR_TO_DATE("27.10.1991.  21:7:48", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("16.8.1992.  5:30:37", "%d.%m.%Y. %H:%i:%s") , 23),
 ( 1121 , STR_TO_DATE("20.5.1994.  9:8:49", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("2.11.2000.  13:35:57", "%d.%m.%Y. %H:%i:%s") , 22),
 ( 1122 , STR_TO_DATE("5.7.1990.  22:40:32", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("6.12.1991.  11:2:9", "%d.%m.%Y. %H:%i:%s") , 41),
 ( 1123 , STR_TO_DATE("20.4.1990.  3:52:12", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("5.8.1993.  6:14:51", "%d.%m.%Y. %H:%i:%s") , 39),
 ( 1124 , STR_TO_DATE("1.2.1993.  9:25:31", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("17.11.1994.  9:30:11", "%d.%m.%Y. %H:%i:%s") , 23),
 ( 1125 , STR_TO_DATE("28.8.1990.  9:16:47", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("21.6.1991.  14:33:47", "%d.%m.%Y. %H:%i:%s") , 35),
 ...
 ( 1128 , STR_TO_DATE("4.4.2000.  13:2:15", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("2.5.2002.  1:51:5", "%d.%m.%Y. %H:%i:%s") , 39),
 ( 1129 , STR_TO_DATE("23.12.1994.  11:9:8", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("6.5.2000.  23:43:55", "%d.%m.%Y. %H:%i:%s") , 20),
 ( 1130 , STR_TO_DATE("16.10.2000.  3:56:34", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("27.11.2002.  6:21:30", "%d.%m.%Y. %H:%i:%s") , 26),
 ...
 ( 1133 , STR_TO_DATE("28.3.1992.  21:39:14", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("20.4.1994.  18:12:41", "%d.%m.%Y. %H:%i:%s") , 40),
 ( 1134 , STR_TO_DATE("4.3.1991.  11:25:59", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("16.3.1998.  5:35:19", "%d.%m.%Y. %H:%i:%s") , 34),
 ( 1135 , STR_TO_DATE("13.5.1990.  23:25:6", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("20.8.1991.  4:19:41", "%d.%m.%Y. %H:%i:%s") , 30),
 ( 1136 , STR_TO_DATE("15.3.1990.  21:30:22", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("19.1.1991.  5:48:10", "%d.%m.%Y. %H:%i:%s") , 36),
 ( 1137 , STR_TO_DATE("22.5.1993.  11:55:28", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("12.2.1995.  16:58:45", "%d.%m.%Y. %H:%i:%s") , 27),
 ( 1138 , STR_TO_DATE("26.2.1995.  7:17:39", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("12.5.1996.  23:40:8", "%d.%m.%Y. %H:%i:%s") , 40 ),
 ( 1139 , STR_TO_DATE("26.2.1994.  14:36:47", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("22.9.1996.  10:5:50", "%d.%m.%Y. %H:%i:%s") , 41 ),
 ( 1140 , STR_TO_DATE("23.5.1991.  22:23:54", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("9.8.1993.  15:6:12", "%d.%m.%Y. %H:%i:%s") , 40 ),
 ...
 ( 1143 , STR_TO_DATE("25.9.1991.  3:50:8", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("11.7.1992.  16:38:58", "%d.%m.%Y. %H:%i:%s") , 17),
 ( 1144 , STR_TO_DATE("14.10.1999.  3:28:3", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("6.8.2002.  14:46:54", "%d.%m.%Y. %H:%i:%s") , 41 ),
 ( 1145 , STR_TO_DATE("7.11.1999.  22:26:4", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("20.3.2000.  19:58:33", "%d.%m.%Y. %H:%i:%s") , 18  ),
 ( 1146 , STR_TO_DATE("19.2.1995.  1:37:15", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("23.7.1998.  7:32:23", "%d.%m.%Y. %H:%i:%s") , 23 ),
 ( 1147 , STR_TO_DATE("12.6.1991.  11:19:55", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("28.2.1999.  14:48:19", "%d.%m.%Y. %H:%i:%s") , 33 ),
 ( 1148 , STR_TO_DATE("12.9.1994.  5:28:31", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("13.10.1995.  12:26:38", "%d.%m.%Y. %H:%i:%s") , 19 ),
 ...
 ( 1152 , STR_TO_DATE("18.12.1992.  16:30:51", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("8.1.1993.  19:0:52", "%d.%m.%Y. %H:%i:%s") , 41 ),
 ( 1153 , STR_TO_DATE("23.2.1991.  11:23:13", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("19.11.1993.  3:35:37", "%d.%m.%Y. %H:%i:%s") , 27 ),
 ( 1154 , STR_TO_DATE("13.5.1995.  6:56:6", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("20.10.1997.  22:40:16", "%d.%m.%Y. %H:%i:%s") , 28 ),
 ( 1155 , STR_TO_DATE("16.9.1996.  19:46:42", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("15.1.1997.  7:32:50", "%d.%m.%Y. %H:%i:%s") , 41 ),
 ( 1156 , STR_TO_DATE("7.4.1993.  20:9:5", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("20.12.1994.  11:6:50", "%d.%m.%Y. %H:%i:%s") , 23 ),
 ( 1157 , STR_TO_DATE("8.10.1992.  22:51:15", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("23.3.1993.  1:40:43", "%d.%m.%Y. %H:%i:%s") , 27 ),
 ( 1158 , STR_TO_DATE("10.1.1991.  23:33:32", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("2.6.1995.  8:18:50", "%d.%m.%Y. %H:%i:%s") , 34 ),
 ( 1159 , STR_TO_DATE("11.3.1990.  4:28:8", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("17.1.1991.  3:33:45", "%d.%m.%Y. %H:%i:%s") , 23 ),
 ( 1160 , STR_TO_DATE("17.3.1994.  2:27:22", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("12.9.1995.  11:21:31", "%d.%m.%Y. %H:%i:%s") , 34 ),
 ( 1161 , STR_TO_DATE("26.2.1990.  16:20:34", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("8.9.1991.  22:15:42", "%d.%m.%Y. %H:%i:%s") , 29 ),
 ( 1162 , STR_TO_DATE("1.7.1998.  8:39:0", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("6.6.1999.  1:53:50", "%d.%m.%Y. %H:%i:%s") , 18 ),
 ...
 ( 1166 , STR_TO_DATE("18.12.1996.  17:59:58", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("2.1.1998.  23:6:41", "%d.%m.%Y. %H:%i:%s") , 34 ),
 ( 1167 , STR_TO_DATE("21.11.1994.  21:21:53", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("27.6.1995.  2:55:20", "%d.%m.%Y. %H:%i:%s") , 23 ),
 ( 1168 , STR_TO_DATE("11.8.1994.  19:22:16", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("17.8.1995.  19:12:44", "%d.%m.%Y. %H:%i:%s") , 30 ),
 ( 1169 , STR_TO_DATE("17.10.1994.  5:5:4", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("18.4.1995.  6:15:2", "%d.%m.%Y. %H:%i:%s") , 23 ),
 ( 1170 , STR_TO_DATE("11.10.1991.  9:20:43", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("27.1.1992.  2:18:19", "%d.%m.%Y. %H:%i:%s") , 17 ),
 ( 1171 , STR_TO_DATE("19.9.1991.  18:7:9", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("27.12.1996.  12:47:10", "%d.%m.%Y. %H:%i:%s") , 31 ),
 ( 1172 , STR_TO_DATE("23.6.1993.  13:16:23", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("23.10.1994.  4:31:11", "%d.%m.%Y. %H:%i:%s") , 21),
 ...
 ( 1175 , STR_TO_DATE("17.4.1991.  15:36:55", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("26.4.1992.  14:48:20", "%d.%m.%Y. %H:%i:%s") , 17),
 ( 1176 , STR_TO_DATE("11.8.1992.  6:55:33", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("22.8.1993.  5:17:41", "%d.%m.%Y. %H:%i:%s") , 23),
 ( 1177 , STR_TO_DATE("20.12.1992.  8:8:9", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("1.11.1993.  9:14:9", "%d.%m.%Y. %H:%i:%s") , 33),
 ( 1178 , STR_TO_DATE("4.2.1992.  12:48:4", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("26.12.1999.  6:53:23", "%d.%m.%Y. %H:%i:%s") , 28),
 ( 1179 , STR_TO_DATE("18.8.1990.  20:3:1", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("26.11.1991.  16:37:9", "%d.%m.%Y. %H:%i:%s") , 39),
 ( 1180 , STR_TO_DATE("21.12.1990.  11:21:2", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("10.9.1991.  17:46:43", "%d.%m.%Y. %H:%i:%s") , 23),
 ( 1181 , STR_TO_DATE("21.8.1993.  12:2:34", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("19.5.2000.  13:28:31", "%d.%m.%Y. %H:%i:%s") , 40),
 ( 1182 , STR_TO_DATE("8.7.1993.  4:1:4", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("18.3.1994.  18:59:39", "%d.%m.%Y. %H:%i:%s") , 35),
 ( 1183 , STR_TO_DATE("21.11.1992.  23:42:5", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("26.11.1993.  14:19:40", "%d.%m.%Y. %H:%i:%s") , 23),
 ( 1184 , STR_TO_DATE("7.2.1995.  13:7:52", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("22.10.1998.  23:52:4", "%d.%m.%Y. %H:%i:%s") , 31),
 ( 1185 , STR_TO_DATE("10.12.1994.  17:10:58", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("16.12.1995.  17:25:29", "%d.%m.%Y. %H:%i:%s") , 23),
 ( 1186 , STR_TO_DATE("1.2.1991.  13:15:16", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("16.10.1992.  18:46:37", "%d.%m.%Y. %H:%i:%s") , 32),
 ...
 ( 1191 , STR_TO_DATE("5.5.1992.  23:32:1", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("20.1.1993.  4:49:19", "%d.%m.%Y. %H:%i:%s") , 33),
 ( 1192 , STR_TO_DATE("8.7.1997.  7:42:45", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("18.4.1998.  18:13:31", "%d.%m.%Y. %H:%i:%s") , 29),
 ( 1193 , STR_TO_DATE("21.10.1994.  3:12:39", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("16.10.1995.  2:37:37", "%d.%m.%Y. %H:%i:%s") , 30),
 ( 1194 , STR_TO_DATE("6.4.1993.  1:53:1", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("23.8.1994.  17:13:30", "%d.%m.%Y. %H:%i:%s") , 17),
 ( 1195 , STR_TO_DATE("13.2.1991.  6:30:50", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("10.3.1999.  23:18:35", "%d.%m.%Y. %H:%i:%s") , 41),
 ( 1196 , STR_TO_DATE("28.10.1991.  21:13:0", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("13.10.1992.  13:21:47", "%d.%m.%Y. %H:%i:%s") , 22),
 ( 1197 , STR_TO_DATE("15.12.1997.  10:8:59", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("5.4.1998.  1:46:44", "%d.%m.%Y. %H:%i:%s") , 40),
 ( 1198 , STR_TO_DATE("4.9.1992.  6:42:53", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("20.6.1993.  7:38:53", "%d.%m.%Y. %H:%i:%s") , 16),
 ( 1199 , STR_TO_DATE("4.8.1991.  16:42:15", "%d.%m.%Y. %H:%i:%s") , STR_TO_DATE("3.9.1992.  9:4:47", "%d.%m.%Y. %H:%i:%s") , 23);
...
INSERT INTO lijecenje VALUES
 ( 1000 , 10036 , "Izliječen" , STR_TO_DATE("28.12.2020.", "%d.%m.%Y.") , STR_TO_DATE("15.3.2021.", "%d.%m.%Y.") , "Srednje ozlijeđen" , 44187 ),
 ...
 ( 1097 , 10920 , "Izliječen" , STR_TO_DATE("24.10.2010.", "%d.%m.%Y.") , NULL , "Srednje ozlijeđen" , 27244 ),
 ( 1098 , 10982 , "U tijeku" , STR_TO_DATE("11.3.2004.", "%d.%m.%Y.") , NULL , "Ozbiljno ozlijeđen" , 50406 ),
